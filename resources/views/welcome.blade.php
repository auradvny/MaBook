      ...
      @endif          <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
                              ...
                              <nav id="navmenu" class="navmenu">
                                <ul>
                                  <li><a href="index.html#hero" class="active">Home qsuhsjskwjkjmedwdrr</a></li>
                            ...
                            <section id="hero" class="hero section">
                              ...
                              <div class="container text-center">
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                  ...
                                  <p data-aos="fade-up" data-aos-delay="100">Discover, Learn, and Grow with Our Digital Library<br></p>

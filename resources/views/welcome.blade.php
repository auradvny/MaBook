        ...
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            @if (Route::has('login'))
                <nav class="-mx-3 flex flex-1 justify-end">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="btn-getstarted rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            Log in
                        </a>
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="btn-getstarted rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                style="background-color: #37B7C3; color: white;">
                                Register
                            </a>
                        @endif
                    @endauth
                </nav>
            @endif <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section">
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1 data-aos="fade-up">Welcome to <span>MaBook</span></h1>
                    <p data-aos="fade-up" data-aos-delay="100">Discover, Learn, and Grow with Our Digital Library<br>
                    </p>
        ...
        <section id="team" class="team section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Our Team</h2>
                <p>Project Rekayasa Perangkat Lunak & Pemrograman Web
                </p>
        ...
        <section id="contact" class="contact section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>For questions, suggestions, or feedback, please contact us in one of the
                    following ways:</p>
            </div><!-- End Section Title -->
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                        <div class="info-item d-flex flex-column justify-content-center align-items-center"
                            ...
                            <h3>Address</h3>
                            <p>Jl. Raya Ajibarang Km. 1 Ajibarang, Kab. Banyumas Jawa Tengah</p>
                        </div>
                    </div><!-- End Info Item -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-item d-flex flex-column justify-content-center align-items-center"
                            ...
                            <h3>Email Us</h3>
                            <p>smkmanusa_ajibarang@yahoo.co.id</p>
                        </div>
                    </div><!-- End Info Item -->
                ...
                <div class="row gy-4 mt-1">
                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31652.604123349203!2d109.05915953955076!3d-7.401366399999984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e65623307fd4e63%3A0x5772bbbc96fd7e41!2sSMK%20Ma&#39;arif%20NU%201%20Ajibarang!5e0!3m2!1sid!2sid!4v1719933894389!5m2!1sid!2sid"

    ...
    <body>
        <x-slot name="header">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center ">
                <h1> <b>
                        <font face="Times New Roman, Helvetica, sans-serif" size="9" color="Black" text-align:
                            center;>
            ...
            <p>
                <font face="Corbel Light, Helvetica, sans-serif" size="3" color="Black" text-align: center;>
                    <center> Perpustakaan SMK Ma'arif NU 1 Ajibarang menyediakan berbagai jenis buku yang dapat kalian
                        pinjam!
            </p>
        </x-slot>
